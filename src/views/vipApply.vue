	...
	<div class="notice-list">
		<div class="nav-top clear">
			...
			<p>当前位置：
				...
				<router-link to="/personApply">个人抵押TITT申请表</router-link>
			</p>
		</div>
		<div class="list">
			<h4>会员卡充值抵押申请表</h4>
			...
			<div class="pay">
				...
				<div class="eos" v-else>
					...
					<div class="two-wallet">
						<div class="wallet">
							<span>TP钱包充值</span>
							<div style="border:1px solid red;    height: 202px;">
								<img style="width: 170px; height: 186px;margin-top: 6px;" src="../assets/images/shoukuanerweima.jpg" alt="" />
							</div>
						</div>
						<div class="wallet">
					...
					<p v-if="form.type == 1">EOS账号：
						<el-input v-model="form.receive_number" style="width: 250px;" placeholder="请输入EOS账号"></el-input>
					</p>
					<p v-if="form.type == 2">到期返还titt账号：
						<el-input v-model="form.receive_number" style="width: 250px;" placeholder="请输入到期返还titt账号"></el-input>
					</p>
					<p v-if="form.type == 2">memo：
						<el-input v-model="form.memo" style="width: 250px;" placeholder="请输入6位数标签数字"></el-input>
					</p>
				</div>
			</div>
...
<script>
	export default {
		...
		methods: {
			...
			getHonggu() {
				this.$axios.get('card/getCardBonus', {
