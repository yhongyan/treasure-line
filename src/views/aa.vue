    ...
    <div class="list">
      ...
      <template v-if="active == 0">
        ...
        >
          ...
          <el-form-item label="银行卡账号:" placeholder="请输入您的银行卡账号" prop="phone">
            <el-input v-model="bankAccount"></el-input>
          </el-form-item>
          <el-form-item label="银行卡正面照片:" placeholder prop="phone">
            <el-upload
      ...
      <template v-else-if="active == 1">
        ...
        <div style="text-align: center;margin-top: 40px;">
          <el-button
            type="info"
            @click="nextStep('back')"
            style="width: 220px;margin: 10px 10px 0 0;"
          >上一步</el-button>
          <el-button
            type="primary"
            style="width: 220px;margin: 10px 10px 0 0;"
