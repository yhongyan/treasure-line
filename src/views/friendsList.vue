	...
	<div class="notice-list">
		<div class="nav-top clear">
			...
			<p>
				...
				<router-link to>好友列表</router-link>
			</p>
		</div>
		<h3>好友列表</h3>
		<div class="list">
			<div class="change-list">
				...
				<el-row class="list-item" v-for="(item,index) in changeList" :key="index">
					...
					<el-col :span="4" class="number">
						<el-button type="text" @click="goSecondFriends(item)">显示</el-button>
					</el-col>
				</el-row>-->
				<el-table :data="changeList" height="" border style="width: 100%">
					<el-table-column align='center' prop="show_id" label="ID名称" width="110">
					</el-table-column>
					<el-table-column align='center' prop="kyc1" label="KYC1认证" width="90">
					</el-table-column>
					<el-table-column align='center' prop="kyc2" label="KYC2认证" width="90">
					</el-table-column>
					<el-table-column align='center' prop="tuiguangma" label="是否申请志愿者" width="120">
					</el-table-column>
					<el-table-column align='center' prop="type" label="是否绑定EOS账户" width="140">
					</el-table-column>
          	<el-table-column align='center' prop="createtime" label="注册时间" width="140">
					</el-table-column>
					<el-table-column align='center' prop="mobile" label="手机后四位" width="100">
					</el-table-column>
					<el-table-column align='center' fixed="right" label="二级邀请好友" width="120">
						<template slot-scope="scope">
							 <el-button type="text" @click="handleEdit(scope.row)">显示</el-button>
						</template>
					</el-table-column>
				</el-table>
			</div>
