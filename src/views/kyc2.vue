  ...
  <div class="notice-list kyc">
    <div class="nav-top clear">
      ...
      <p>
        ...
        <router-link to="/kyc2">KYC2认证</router-link>
      </p>
    </div>
    <div class="list">
      <h4>
      ...
      <template v-if="active == 0">
        <el-form
          ...
          label-width="115px"
          class="demo-ruleForm"
          style="max-width: 400px;margin: 60px auto 40px;"
        >
          <el-form-item label="选择国家" prop="phone">
            <el-select v-model="ruleForm.country" placeholder="请选择您的国家" style="width: 100%;">
              <el-option
                ...
                :key="index"
                :label="item.area + item.phone"
                :value="item.area"
              ></el-option>
            </el-select>
          </el-form-item>
          <!--<el-form-item label="选择银行" prop="phone">
						<el-select v-model="ruleForm.bank" placeholder="请选择您的银行" style="width: 100%;">
							<el-option v-for="(item,index) in bankList" :key="index" :label="item.text + item.value" :value="item.text"></el-option>
						</el-select>
          </el-form-item>-->
          <el-form-item label="银行卡账号" placeholder="请输入您的银行卡账号" prop="bankAccount">
            <el-input v-model="ruleForm.bankAccount"></el-input>
          </el-form-item>
          <el-form-item label="银行卡正面照片" placeholder prop="img1">
            <el-upload
            ...
            >
              <img v-if="img1" :src="img1" alt style="width:100%" />
              <img v-else src="../assets/images/bankCard.png" alt style="width:100%" />
            </el-upload>
            <div class="text">
        ...
        <div style="text-align: center">
          <el-button type="primary" style="width: 220px;" @click="saveData">下一步</el-button>
        </div>
      </template>
      ...
      <!--<template v-else-if="active == 1">
				...
				<div class="row">
					<div class="upload-img col-lg-6 col-md-6 col-sm-12">
						<p>个人身份证背面照片</p>
						<el-upload class="avatar-uploader" :action="uploadUrl" :show-file-list="false" :on-success="handleAvatarSuccess2" :before-upload="beforeAvatarUpload">
				...
				<div class="row">
					<div class="upload-img col-lg-6 col-md-6 col-sm-12">
						<p>手持身份证正面照片</p>
						<el-upload class="avatar-uploader" :action="uploadUrl" :show-file-list="false" :on-success="handleAvatarSuccess3" :before-upload="beforeAvatarUpload">
      ...
      <template v-else-if="active == 2">
        <p
          style="font-size: 18px;color: #f07e1b;text-align: center;margin: 100px 0 120px;"
        >请等待公司审核，一般会在2～5个工作日内审核完成。请留意本页更新。</p>
        <div style="text-align: center">
...
//	import bank from '../assets/json/bank'
export default {
  name: "notice-list",
  data() {
    return {
  ...
  methods: {
    ...
    saveData() {
      var params = {
        ...
        banknum: this.ruleForm.bankAccount,
        bankimg: this.img1,
        token: sessionStorage.getItem("token")
      };
      console.log(params);
      this.$axios.post("user/kyc3renzhengnew", params).then(res => {
        if (res.data.sta == 401) {
